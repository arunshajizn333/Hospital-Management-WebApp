...
// // @route   POST api/patients (Doctor or Admin creates a new patient profile)
// // @desc    Doctor or Admin creates a new patient profile (e.g., walk-in not registered)
...
// // @route   GET api/patients/doctor-search (Doctor searches for patients)
...
// // @access  Private (Admin)
// // router.put('/admin/:patientId/status', protect, authorize('admin'), patientController.updatePatientStatusByAdmin); // We'll add this controller later
